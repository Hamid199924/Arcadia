...
// Construire la requête SQL avec des filtres conditionnels pour les animaux
...
<div class="container my-4">
    ...
    <section class="user-section mb-5">
        ...
        <div class="row mt-5">
            <?php
            // Affichage des utilisateurs si $stmtuser est défini
            if (isset($stmtuser)) {
                while ($userRow = $stmtuser->fetch(PDO::FETCH_ASSOC)): ?>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <form action="/actions/animals/update_animal.php" method="post">
                    ...
                    </form> <!-- Fermeture du formulaire de modification -->
