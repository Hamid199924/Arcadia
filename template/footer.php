<footer class="bg-dark text-white text-centre mt-3 ms-auto"footer>
    <div class="row d-flex">
        <div class="col-12 col-lg-4">
            <h3 class="text-white">Nos horaires</h3>
            <p>Du lundi au Vendredi 08:   18:00<br/> 
               Samedi et  Dimanche  08:   20:00<br/>
            </p>
        </div>
       
        <div class="col-6 col-lg-4">
            <p>Zoo Arcadia <br/>
            Forêt de Broceliande <br/>
            35380 Paimpont<br/>
                
            </p>
        </div>
        <div class="col-6 col-lg-4 text-md-right">
          <p>ZooArcadia@gmail.com</p>
        </div>
        ...
        <div class="col-6 col-lg-4">
          ...
          <a href="../public/Formulaire.php" class="btn btn-primary contact-button">Contacter nous</a>
        </div>
